            ...
            <div className="min-h-screen bg-white">
                <div className="bg-[#F5FBF2]  px-4 py-8">
                    <div className="max-w-6xl mx-auto">
                        <Link to="/products">
                            <button className="flex items-center text-black font-mono mt-8 hover:bg-[#EADAC8] hover:rounded-full hover:px-3 cursor-pointer mb-4">
                ...
                <div className="max-w-6xl mx-auto px-4 py-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-4">
                            {cartItems.map((item) => (
                                <div key={item.id} className="bg-white rounded-lg p-7 shadow-md">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <span className="text-black font-mono text-m">Qty: {item.quantity}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="text-right">
                                            <div className="font-bold text-lg  rounded-xl px-2 py-2 bg-[#d6d8d5] text-black">GH₵{item.total}</div>
                                        </div>

                                        <button className="text-black hover:text-amber-800 hover:bg-[#d6d8d5] hover:rounded-lg hover:py-2 px-3 cursor-pointer p-1"
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-lg p-6 shadow-md sticky top-8">
                                <h2 className="text-xl font-mono font-bold text-black mb-6">Order Summary</h2>

                                <div className="space-y-4 mb-6">
                                    <div className="flex justify-between">
                                        <span className="text-black">Subtotal</span>
                                        <span className="text-black">
                                            GH₵{cartItems.reduce((sum, item) => sum + item.total, 0).toFixed(2)}
                                        </span>
                                    </div>
